...
This repository holds the code (Model.ipynb) and analysis developed for the **Master's Research Thesis** by **Lorenzo van Cadsand**.
...
To run the simulation you can use the csv file contained in the data repository. 

Actual global exposure in World portfolio is: 35% North America, 20% Europe, 20% Asia, 10% South America, 10% Africa, 5% Rest of the world (Oceania).
